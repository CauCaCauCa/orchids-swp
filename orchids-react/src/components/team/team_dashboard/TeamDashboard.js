            ...
            <>
                <Box id="team-dashboard" mt={5}>
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '467px', height: '69px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '454px', height: '72px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '684px', height: '66px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '795px', height: '57px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '634px', height: '54px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '254px', height: '73px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '387px', height: '51px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '908px', height: '68px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '831px', height: '63px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '628px', height: '74px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '512px', height: '73px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '667px', height: '75px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '795px', height: '67px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '423px', height: '57px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '887px', height: '65px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '306px', height: '63px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '456px', height: '51px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '767px', height: '59px', mb: 2 }}
                    />
                    <Skeleton
                        variant="rounded"
                        color="primary"
                        sx={{ width: '998px', height: '58px', mb: 2 }}
                    />
                </Box>
            </>
        );
        ...
        <>
            <Box id="team-dashboard" mt={5}>
                ...
                <TeamContainer
                    id="owning-teams"
                    title="Nhóm của bạn"
                    teams={teamList.ListEmailTeamOwner}
                />
                <TeamContainer
                    id="member-teams"
                    title="Nhóm bạn tham gia"
                    teams={teamList.ListEmailTeamAttend}
                />
            </Box>
            <CreateTeam
                open={openCreateTeam}
                setOpen={setOpenCreateTeam}
...
function CreateTeam({ open, setOpen, setAccount, account }) {
    ...
    const handleSubmit = (e) => {
        ...
        const addTeamToDB = async () => {
            const response = await CreateTeamInDB(
                teamname,
                description,
                bground,
                avatar
    ...
    return (
        <>
            ...
            <Dialog
                ...
                onClose={() => setOpenFileUploader(false)}
            >
                ...
                <DialogActions>
                    <Button onClick={() => setOpenFileUploader(false)}>
                        Finish
                    </Button>
                </DialogActions>
            </Dialog>
